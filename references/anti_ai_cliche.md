...
- **Trailing Colons in Headings**: `## 步骤 1：安装` $\rightarrow$ `## 步骤 1 安装`
- **Unfounded Praise**: `powerful`, `robust`, `blazing-fast`, `seamless`, `enterprise-grade` (unless backed by cited benchmark data)
