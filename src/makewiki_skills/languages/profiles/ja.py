...
PROFILE = LanguageProfile(
    ...
    generation_hints=(
        ...
        "一文には一つの内容だけを書き、長文は短く分割し、文の長さに緩急をつけてください。"
        "同じ対象は同じ呼び方で統一し、重複を避けるための言い換えで語を格上げしないでください。"
        "出典のない「研究によると」といった表現を書かず、事実はありのままの強さで述べ、"
        "結びに感想や展望を付けないでください。"
        "「要するに」「一言でいえば」「〜ではなく〜である」といったAI定型文を避けてください。"
    ),
    file_suffix=".ja",
)
